...
function processPath(resourcePath: string): Response | Promise<Response> | undefined {
    try {
...
function getResource(resourcePath: string, root = ""): { body?: BodyInit, init?: ResponseInit } {
